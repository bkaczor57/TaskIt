...
export const InviteModal = ({ onClose, teamId }) => {
  const [email, setEmail] = useState('');
  const [selectedRole, setSelectedRole] = useState('');
  const [localError, setLocalError] = useState(null); // Dodajemy error lokalny
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLocalError(null); // resetuj error przed wysyłką
    try {
